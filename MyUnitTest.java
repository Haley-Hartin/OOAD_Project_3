...
public class MyUnitTest {
    ...
    @Test
    public void testchoosePriceEggRoll() {
        Roll eggroll = new EggRoll(2.00);

        ExtraSauces filling = new ExtraSauces(eggroll,1);

        double result = filling.choosePrice("Egg Roll");

        assertEquals(0.60,result,0.0);
